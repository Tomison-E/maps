...
class MapboxMap extends Camera {
  ...
  MapboxMap setMinPitch([num? minPitch]) =>
      MapboxMap.fromJsObject(jsObject.setMinPitch(minPitch));
  ...
  MapboxMap setMaxPitch([num? maxPitch]) =>
      MapboxMap.fromJsObject(jsObject.setMaxPitch(maxPitch));
  ...
  List<String> listImages() =>
      jsObject.listImages().toDart.map((e) => e.toDart).toList();
  ...
  List<dynamic> getFilter(String layerId) =>
      jsObject.getFilter(layerId).toDart;
  ...
  web.HTMLElement getContainer() => jsObject.getContainer();
  ...
  ///  @see [Create a draggable point](https://www.mapbox.com/mapbox-gl-js/example/drag-a-point/)
  ///  @see [Highlight features within a bounding box](https://www.mapbox.com/mapbox-gl-js/example/using-box-queryrenderedfeatures/)
  web.HTMLElement getCanvasContainer() => jsObject.getCanvasContainer();
  ...
  web.HTMLCanvasElement getCanvas() => jsObject.getCanvas();
  ...
  set showTileBoundaries(bool value) => jsObject.showTileBoundaries = value;
  ...
  set showCollisionBoxes(bool value) => jsObject.showCollisionBoxes = value;
  ...
  set showOverdrawInspector(bool value) => jsObject.showOverdrawInspector = value;
  ...
  set repaint(bool value) => jsObject.repaint = value;

  /// show vertices
  bool get vertices => jsObject.vertices;
  set vertices(bool value) => jsObject.vertices = value;
...
class MapOptions extends JsObjectWrapper<MapOptionsJsImpl> {
  ...
  bool? get failIfMajorPerformanceCaveat => jsObject.failIfMajorPerformanceCaveat?.toDart;
  ...
  LngLatBounds? get maxBounds =>
      jsObject.maxBounds != null ? LngLatBounds.fromJsObject(jsObject.maxBounds!) : null;
  ...
  LngLatBounds? get bounds =>
      jsObject.bounds != null ? LngLatBounds.fromJsObject(jsObject.bounds!) : null;
  ...
  String? get localIdeographFontFamily => jsObject.localIdeographFontFamily?.toDart;
  ...
  factory MapOptions({
    ...
    dynamic locale,
      ...
      MapOptions.fromJsObject(MapOptionsJsImpl(
        //hash: hash,
        interactive: interactive?.toJS ?? true.toJS,
        container: container is String ? container.toJS : container,
        bearingSnap: bearingSnap?.toJS,
        ...
        refreshExpiredTiles: refreshExpiredTiles?.toJS,
        maxBounds: maxBounds?.jsObject,
        scrollZoom: scrollZoom?.toJS ?? true.toJS,
        minZoom: minZoom?.toJS,
        ...
        keyboard: keyboard?.toJS ?? true.toJS,
        doubleClickZoom: doubleClickZoom?.toJS ?? true.toJS,
        touchZoomRotate: touchZoomRotate?.toJS ?? true.toJS,
        trackResize: trackResize?.toJS ?? true.toJS,
...
class IControl extends JsObjectWrapper<IControlJsImpl> {
  ...
  ///  internally.
  web.HTMLElement onAdd(MapboxMap map) => jsObject.onAdd(map.jsObject);
