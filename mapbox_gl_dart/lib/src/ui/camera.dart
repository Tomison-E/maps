...
class Camera extends Evented {
  ...
  ///  @param {Object} [options] Options supports all properties from AnimationOptions and CameraOptions in addition to the fields below.
  ///  @param {number | PaddingOptions} `options.padding` The amount of padding in pixels to add to the given bounds.
  ///  @param {boolean} `options.linear=false` If `true`, the map transitions using
  ///      MapboxMap#easeTo. If `false`, the map transitions using MapboxMap#flyTo. See
  ///      those functions and AnimationOptions for information about options available.
  ///  @param {Function} `options.easing` An easing function for the animated transition. See AnimationOptions.
  ///  @param {PointLike} `options.offset=[0, 0]` The center of the given bounds relative to the map's center, measured in pixels.
  ...
  MapboxMap fitScreenCoordinates(Point p0, Point p1, num bearing,
      ...
      MapboxMap.fromJsObject(jsObject.fitScreenCoordinates(
          p0.jsObject, p1.jsObject, bearing));
  ...
  ///             Accepts CameraOptions and AnimationOptions.
  ///  @param eventData Additional properties to be added to event objects of events triggered by this method.
  ///  @fires movestart
  ///  @fires zoomstart
  ///  @fires pitchstart
  ...
  MapboxMap easeTo(dynamic options, [dynamic eventData]) =>
      MapboxMap.fromJsObject(jsObject.easeTo(jsifyAny(options)));
  ...
  ///      Accepts CameraOptions, AnimationOptions,
  ///      and the following additional options.
  ///  @param {number} [options.curve=1.42] The zooming "curve" that will occur along the
  ///      flight path. A high value maximizes zooming for an exaggerated animation, while a low
  ///      value minimizes zooming for an effect closer to MapboxMap#easeTo. 1.42 is the average
