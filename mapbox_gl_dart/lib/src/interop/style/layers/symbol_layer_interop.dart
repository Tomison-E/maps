...
class SymbolLayerJsImpl {
  static JSObject toJs(SymbolLayer symbolLayer) => jsify(toDict(symbolLayer));
...
class SymbolPaintJsImpl {
  static JSObject toJs(SymbolPaint symbolPaint) => jsify(toDict(symbolPaint));
...
class SymbolLayoutJsImpl {
  static JSObject toJs(SymbolLayout symbolLayout) => jsify(toDict(symbolLayout));
