...
class LineLayerJsImpl {
  static JSObject toJs(LineLayer lineLayer) => jsify(toDict(lineLayer));
...
class LinePaintJsImpl {
  static JSObject toJs(LinePaint linePaint) => jsify(toDict(linePaint));
...
class LineLayoutJsImpl {
  static JSObject toJs(LineLayout lineLayout) => jsify(toDict(lineLayout));
